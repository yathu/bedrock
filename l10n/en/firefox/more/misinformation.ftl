...
misinformation-page-desc = Misinformation is annoying, distracting and expensive. { -brand-name-firefox } helps you identify false information – and lets you see less of it when browsing the web.
...
misiinformation-social-media-clean-desc = Social networks know a lot about you through your activities on the sites as well as cross-site tracking. Additionally, they’re also able to track you beyond their platforms with their Share and Like buttons despite Tracking Protection — and even if you don’t have an account. The <a href="{ $container }">{ -brand-name-facebook-container }</a> for { -brand-name-firefox } makes sure that { -brand-name-facebook } and { -brand-name-instagram } can't do this so easily anymore, reducing the probability of seeing false information via ads and promoted content..
...
#   $pocket-hits (url) - link to https://getpocket.com/explore/pocket-hits-signup
#   $pocket (url) - link to https://getpocket.com/
misinformation-surface-content-desc = When you open a new tab in your { -brand-name-firefox } browser, you’ll see a wide selection of articles <a href="{ $recommended }">recommended by { -brand-name-pocket }</a>. These articles are curated by real people based on content { -brand-name-pocket } users highlight as worth to read. This enables you to see the bigger picture, discover new stories and opinions, and battle the spread of false information. To get even more recommendations, subscribe to the <a href="{ $pocket_hits }">{ -brand-name-pocket } newsletter</a> and make sure to save any stories you’d like to come back to later in your <a href="{ $pocket }">{ -brand-name-pocket } app</a>, as well.
